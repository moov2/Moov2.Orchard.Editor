...
namespace Moov2.Orchard.Editor
{
    public class ResourceManifest : IResourceManifestProvider
    {
        public void BuildManifests(ResourceManifestBuilder builder)
        {
            ...
            manifest.DefineScript("MediumInsertPluginJs").SetUrl("medium/plugins/medium-editor-insert-plugin.min.js", "medium/plugins/medium-editor-insert-plugin.js").SetDependencies("jQuery", "Handlebars", "jQuerySortable", "jQueryWidget", "jQueryIFrameTransport", "jQueryFileUpload");
